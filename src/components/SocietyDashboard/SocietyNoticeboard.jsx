...
const SocietyNoticeboard = () => {
  ...
  const fetchFederationNotices = async (decoded) => {
    try {
      const fedRes = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/notices/federation-id/${decoded.society_id}`);
  ...
  const handleApprove = async (notice_id) => {
    try {
      await axios.put(`${import.meta.env.VITE_BACKEND_URL}/notices/approve-notice/${notice_id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editing) {
        await axios.put(`${import.meta.env.VITE_BACKEND_URL}/notices/edit-notice/${formData.notice_id}`, formData);
        showToast('Notice updated!');
      } else {
        await axios.post(`${import.meta.env.VITE_BACKEND_URL}/notices/post-notice`, formData);
